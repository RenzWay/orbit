...
import { ArrowRight, MonitorX, Send, UploadCloud } from "lucide-react";
import { useEffect, useState } from "react";
import { useNavigate } from "react-router-dom";
import { handleLogout } from "@/utils/handle/handleLogout";
          ...
          <ul className="list-none space-y-2">
            {devices.length === 0 ? (
              <>
                ...
                {/* <li
                  className={`flex gap-4 items-center transition-all p-3 rounded-2xl cursor-pointer bg-sky-500/30 dark:bg-sky-800/60 border border-sky-400`}
                >
                  ...
                  <div>
                    <h4 className="font-semibold text-sm">vivo y12</h4>
