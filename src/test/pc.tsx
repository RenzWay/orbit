...
export default function OrbitDesktop() {
  ...
  return (
    <div className="w-[720px] h-[440px] mx-auto bg-[#0B0F1A] rounded-xl overflow-hidden border border-white/5 flex font-sans text-white">
      {/* Sidebar */}
      <div className="w-[220px] bg-[#0E1420] border-r border-white/5 p-4 flex flex-col">
        <div className="mb-6 px-1">
          <p className="text-[10px] uppercase tracking-widest text-[#4DE8C7]/70">
            Orbit
          </p>
          <h1 className="text-base font-semibold">Device kamu</h1>
        </div>
        ...
        <div className="mt-auto flex items-center gap-2 bg-[#12281F] border border-[#4DE8C7]/20 rounded-lg px-2.5 py-2">
          ...
          <p className="text-[10px] text-[#4DE8C7]">Aktif di tray</p>
        </div>
      </div>
